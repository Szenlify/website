...
export default function Platforms({ dict }: PlatformsProps) {
    ...
    return (
        <section className="py-20 sm:py-32 border-y border-white/[0.08] bg-[#050711]/50 relative z-10" aria-label={platforms.label}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <p className="text-xs sm:text-sm font-mono font-bold uppercase tracking-[0.25em] text-slate-400 mb-12 sm:mb-16">
                    {platforms.label}
                </p>

                <div className="flex items-center justify-center gap-10 sm:gap-14 lg:gap-20 flex-wrap">
                    {/* Netflix */}
                    <div className="flex items-center transition-transform duration-200 hover:scale-105" title="Netflix Dual Subtitles">
                        <Image
                    ...
                    >
                        ...
                        <span className="font-display font-extrabold text-xl sm:text-2xl text-white tracking-tighter">
                            YouTube
                        </span>
                    </div>

                    {/* TED Talks */}
                    <div className="transition-transform duration-200 hover:scale-105" title="TED Talks">
                        <svg
                    ...
                    {/* X.com */}
                    <div className="transition-transform duration-200 hover:scale-105" title="X (Twitter)">
                        <svg
                            className="h-5 sm:h-6 w-auto fill-white"
                            viewBox="0 0 24 24"
                            role="img"
                            aria-label="X"
                        >
                    ...
                    >
                        ...
                        <span className="font-display font-extrabold text-xl sm:text-2xl text-[#E5A00D] tracking-wider">
                            PLEX
                    ...
                    >
                        <div className="size-8 sm:size-9 rounded-xl bg-cyan-500/15 border border-cyan-500/30 flex items-center justify-center text-cyan-400">
                            <svg
                                className="size-5"
                                viewBox="0 0 24 24"
                                fill="none"
