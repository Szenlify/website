    ...
    <section className="py-10 sm:py-12 border-y border-white/10 bg-[#050711]/60 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex items-center justify-center gap-6 sm:gap-10 lg:gap-14 flex-wrap">
          {/* Netflix */}
          <Image src="/platforms/netflix.png" alt="Netflix" width={100} height={100} />
          ...
          >
            ...
            >
              <path
                ...
                fill="#FF0000"
              />
              <path d="M11.4253 14.2854L18.854 10L11.4253 5.7146V14.2854Z" fill="white" />
            </svg>
          ...
          {/* TED Talks */}
        <svg className="h-6 lg:mr-3" aria-hidden="true" viewBox="0 0 68 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M21.419 0V6.15129H14.6559V24H7.21617V6.15129H0.453125V0H21.419ZM42.9026 0V6.14144L29.985 6.15129V9.09722H42.9026V14.8271L29.985 14.8182V17.8489H42.9026V24H22.5455V0H42.9026ZM56.3491 0C64.3969 0 67.2375 5.91584 67.2375 11.9665C67.2375 19.3279 63.3154 24 54.8947 24H44.1417V0H56.3491ZM53.9481 6.15129H51.5812V17.8489H54.489C59.122 17.8489 59.7983 14.1177 59.7983 11.8658C59.7983 10.3532 59.3247 6.15129 53.9481 6.15129Z" fill="#EB0028"></path></svg>
          ...
          >
            <svg
              ...
              aria-label="Plex"
            >
              <path d="M18.6667 14L8.4 0H0L10.2667 14L0 28H8.4L18.6667 14Z" fill="#E5A00D" />
              <path d="M28 14L17.7333 0H9.33333L19.6 14L9.33333 28H17.7333L28 14Z" fill="#EB9C00" />
            </svg>
