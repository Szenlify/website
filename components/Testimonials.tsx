        ...
        <section className="relative z-10 overflow-hidden py-24 sm:py-36 lg:py-44" id="testimonials">
            ...
            <div className="mx-auto">
                ...
                <div className="mx-auto px-4 mb-14 sm:mb-20 max-w-3xl text-center">
                    <span className="mb-4 inline-block rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-cyan-300">
                        {testimonials.tag}
                    </span>
