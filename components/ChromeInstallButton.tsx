...
export default function ChromeInstallButton({
    ...
    return (
        <Link
            ...
            className={`${styles.chromeInstallBtn} group inline-flex w-full items-center justify-center transition-transform duration-300 motion-safe:hover:-translate-y-0.5 active:translate-y-0 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-indigo-300 sm:w-auto ${className}`}
        >
