...
const PRICING_COPY: Record<Locale, PricingCopy> = {
    pl: {
        ...
        ttsMonthly: (c) => `${c} znaków Gemini TTS / mies.`,
    ...
    en: {
        ...
        ttsMonthly: (c) => `${c} Gemini TTS chars / mo`,
    ...
    de: {
        ...
        ttsMonthly: (c) => `${c} Gemini TTS Zeichen / Mon.`,
    ...
    es: {
        ...
        ttsMonthly: (c) => `${c} caracteres Gemini TTS / mes`,
    ...
    fr: {
        ...
        ttsMonthly: (c) => `${c} car. Gemini TTS / mois`,
    ...
    it: {
        ...
        ttsMonthly: (c) => `${c} car. Gemini TTS / mese`,
    ...
    cs: {
        ...
        ttsMonthly: (c) => `${c} znaků Gemini TTS / měs.`,
    ...
    nl: {
        ...
        ttsMonthly: (c) => `${c} Gemini TTS-tekens / mnd`,
    ...
    pt: {
        ...
        ttsMonthly: (c) => `${c} car. Gemini TTS / mês`,
    ...
    ja: {
        ...
        ttsMonthly: (c) => `${c} 文字 Gemini TTS / 月`,
        systemVoice: "システム音声",
        signingIn: "ログイン中…",
        prevPlan: "前のプラン",
        nextPlan: "次のプラン",
