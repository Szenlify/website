...
export default function Pricing() {
  return (
    <section className="py-24 border-t border-white/10 bg-[#050711]/40 relative z-10" id="pricing">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto items-stretch">
          ...
          <div className="glass-panel p-8 sm:p-9 flex flex-col justify-between">
            <div>
              <div className="font-display font-extrabold text-2xl text-white mb-1">FREE</div>
              <p className="text-xs text-slate-400 mb-6">For casual viewers and beginners</p>
              ...
              <ul className="space-y-3.5 text-sm text-slate-300 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span>Dual subtitles for Netflix & YouTube</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                  <span>Up to <strong>50 saved SRS flashcards</strong></span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                  <span>Standard browser speech synthesis</span>
                </li>
              </ul>
            </div>
          ...
          <div className="glass-panel p-8 sm:p-9 flex flex-col justify-between relative bg-gradient-to-b from-[#1e274d]/90 to-[#0e1222]/95 border-2 border-indigo-500 shadow-2xl shadow-indigo-500/25 md:-translate-y-2">
            ...
            <div>
              <div className="font-display font-extrabold text-2xl text-indigo-400 mb-1">BASIC</div>
              <p className="text-xs text-slate-400 mb-6">For regular language learners</p>

              <div className="flex items-baseline gap-1 mb-8">
                <span className="font-display font-black text-5xl text-white">$7.99</span>
              ...
              <ul className="space-y-3.5 text-sm text-slate-200 mb-8">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                  <span>Up to <strong>3,000 SRS flashcards</strong> in cloud</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                  <span><strong>20,000 ElevenLabs characters</strong> / mo</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                  <span>1-Click export to Anki, PDF, and CSV</span>
                </li>
              </ul>
            </div>
          ...
          <div className="glass-panel p-8 sm:p-9 flex flex-col justify-between">
            <div>
              <div className="font-display font-extrabold text-2xl text-white mb-1">PRO</div>
              <p className="text-xs text-slate-400 mb-6">For exam preparation & polyglots</p>

              <div className="flex items-baseline gap-1 mb-8">
                <span className="font-display font-black text-5xl text-white">$19.99</span>
                <span className="text-sm font-semibold text-slate-400">/ month</span>
              </div>
              ...
              <ul className="space-y-3.5 text-sm text-slate-300 mb-8">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                  <span>Up to <strong>10,000 SRS flashcards</strong></span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
                  <span><strong>120,000 ElevenLabs characters</strong> / mo</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 font-bold">✓</span>
