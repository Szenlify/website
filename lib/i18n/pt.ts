...
export const pt: Dict = {
    ...
    showcase: {
        ...
        title: "Veja o Lectoro AI em ação",
        previous: "Captura anterior",
        next: "Próxima captura",
        slideLabel: "Captura",
        s1: {
            alt: "Legendas clicáveis e painel de tradução do Lectoro AI em um vídeo TED",
            title: "Aprenda com legendas de vídeo clicáveis",
        },
        s2: {
            alt: "Extensão Lectoro AI no Chrome traduzindo texto selecionado e legendas no X",
            title: "Traduza texto em qualquer página da web",
        },
        s3: {
            alt: "Guia de configuração do Lectoro AI para legendas no YouTube e Netflix, atalhos de teclado e revisões com flashcards",
            title: "Fluxo de aprendizado e revisão em vídeo",
        },
        s4: {
            alt: "Tradução de legendas de inglês para alemão com explicação contextual por IA no YouTube usando Lectoro AI",
            title: "A IA explica expressões no contexto",
        },
        s5: {
            alt: "Flashcard de repetição espaçada do Lectoro AI com captura de cena salva do Netflix",
            title: "Revise flashcards de vídeo com SRS",
        },
        s6: {
            alt: "Barra do Lectoro AI traduzindo e lendo palavras selecionadas em uma postagem no X",
            title: "Traduza, ouça ou pergunte para a IA",
        },
        s7: {
            alt: "Tradução de inglês para francês e explicação de expressão idiomática sobre um vídeo no Lectoro AI",
            title: "Entenda expressões idiomáticas enquanto assiste",
        },
        s8: {
            alt: "Revisão diária de flashcards do Lectoro AI aberta ao lado do catálogo de streaming do Plex",
            title: "Aprenda e revise vocabulário no Plex",
        },
    },

    comparison: {
        tag: "Comparação direta de recursos",
        title: "Compare extensões e apps para aprender idiomas",
        titleHighlight: "Recurso por recurso",
        subtitle:
            "Compare o Lectoro AI com outras abordagens populares de imersão em vídeo e aprendizado de idiomas.",
        disclaimer:
            "Baseado em recursos e preços divulgados publicamente; disponibilidade e valores podem variar.",
        winnerBadge: "Vencedor",
        lectoSubtitle: "Imersão em mídia com IA de nova geração",
        lrSubtitle: "Extensão legada (ex-LLN)",
        lingoSubtitle: "Plataforma de streaming curada",
        featureCol: "Recurso e capacidade",
        previousAriaLabel: "Comparação anterior",
        slidesAriaLabel: "Slides de comparação",
        goToAriaLabel: "Ir para comparação",
        nextAriaLabel: "Próxima comparação",
        verdictTag: "Veredito",
        verdictTitle:
            "Escolha o fluxo que combina com a forma como você já aprende.",
        verdictBody:
            "O Lectoro AI combina inteligência contextual de IA, navegação por teclado e capturas de vídeo, com um plano gratuito disponível para começar.",
        verdictCta: "Adicionar ao Chrome grátis ➔",
        tabs: {
            vsLR: "vs. Language Reactor",
            vsLRbadge: "Concorrente principal",
            vsLingopie: "vs. Lingopie",
            vsLingopieBadge: "Plataforma de streaming",
            vsDuolingo: "vs. Duolingo",
            vsDuolingoBadge: "App baseado em cursos",
        },
        rows: [
            {
                category: "IA e inteligência",
                feature: "Tutor de IA contextual (gírias e expressões)",
                description:
                    "Explica referências culturais com nuance, piadas e phrasal verbs em tempo real.",
                lectoro: {
                    title: "Tutor de IA",
                    detail: "Explica gírias, humor cultural e gramática em 1 frase precisa.",
                    isPositive: true,
                },
                languageReactor: {
                    title: "Ferramentas de tradução e consulta",
                    detail: "Oferece legendas bilíngues, dicionário e tradução automática no Pro.",
                    isPositive: false,
                },
                lingopie: {
                    title: "Significados conversacionais",
                    detail: "Inclui significados contextuais, flashcards de vídeo e explicações gramaticais.",
                    isPositive: false,
                },
                duolingo: {
                    title: "Recursos de IA baseados em curso",
                    detail: "Recursos de conversa com IA variam por curso, plataforma e plano.",
                    isPositive: false,
                },
            },
            {
                category: "Liberdade de conteúdo",
                feature: "Plataformas compatíveis e leitura na web",
                description:
                    "Onde você realmente pode aprender sem pagar extra ou trocar de app.",
                lectoro: {
                    title: "YouTube, Netflix e web inteira",
                    detail: "Funciona em vídeos E em qualquer página da web, notícias, Reddit ou X (Twitter).",
                    isPositive: true,
                },
                languageReactor: {
                    title: "Netflix, YouTube, livros e web",
                    detail: "Suporta vídeos, podcasts, páginas importadas e livros enviados no desktop.",
                    isPositive: false,
                },
                lingopie: {
                    title: "Catálogo de streaming curado",
                    detail: "Oferece milhares de séries, filmes, podcasts e outros conteúdos de aprendizado.",
                    isPositive: false,
                },
                duolingo: {
                    title: "Conteúdo de curso estruturado",
                    detail: "Foca em lições guiadas em vez de aprender em páginas web arbitrárias.",
                    isPositive: false,
                },
            },
            {
                category: "Ergonomia e UX",
                feature: "Fluxo por teclado sem mouse",
                description:
                    "Reprodução de vídeo sem mãos e navegação de legendas direto do sofá.",
                lectoro: {
                    title: "Navegação por teclado",
                    detail: "Navegue pelas legendas, controle a reprodução e acesse ferramentas de aprendizado no teclado.",
                    isPositive: true,
                },
                languageReactor: {
                    title: "Controles por teclado e gestos",
                    detail: "Fornece atalhos e gestos para navegação e reprodução de vídeo com precisão.",
                    isPositive: false,
                },
                lingopie: {
                    title: "Player de vídeo interativo",
                    detail: "Palavras podem ser selecionadas diretamente das legendas enquanto você assiste ao catálogo.",
                    isPositive: false,
                },
                duolingo: {
                    title: "Exercícios interativos",
                    detail: "Usa exercícios curtos de escuta, fala, escrita e seleção.",
                    isPositive: false,
                },
            },
            {
                category: "Retenção de memória",
                feature: "Capturas automáticas de cena para Anki",
                description:
                    "Captura quadros visuais para que sua memória conecte palavras diretamente às cenas.",
                lectoro: {
                    title: "Capturas automáticas de cena",
                    detail: "Associa vocabulário salvo a quadros de alta resolução da cena atual.",
                    isPositive: true,
                },
                languageReactor: {
                    title: "Ferramentas de vocabulário salvo",
                    detail: "Permite salvar vocabulário; opções de exportação com mídia dependem do fluxo.",
                    isPositive: false,
                },
                lingopie: {
                    title: "Flashcards de vídeo",
                    detail: "Monta flashcards com vocabulário encontrado no catálogo de vídeos.",
                    isPositive: false,
                },
                duolingo: {
                    title: "Visuais de curso",
                    detail: "Usa ilustrações do curso em vez de capturas da mídia do aluno.",
                    isPositive: false,
                },
            },
            {
                category: "Exportação e propriedade",
                feature: "Exportação para Anki e Excel em 1 clique",
                description:
                    "Tenha sua base de vocabulário para sempre, sem lock-in de plataforma.",
                lectoro: {
                    title: "Anki .txt / CSV / PDF em 1 clique",
                    detail: "Exporta vocabulário salvo nos formatos listados em outras partes deste site.",
                    isPositive: true,
                },
                languageReactor: {
                    title: "Exportação de vocabulário disponível",
                    detail: "Formato de exportação e suporte de mídia dependem do plano e do fluxo escolhidos.",
                    isPositive: false,
                },
                lingopie: {
                    title: "Revisão de vocabulário no app",
                    detail: "As páginas oficiais destacam flashcards e ferramentas de repetição no app.",
                    isPositive: false,
                },
                duolingo: {
                    title: "Progresso no app",
                    detail: "Planos oficiais focam em progresso de curso sincronizado, não exportação de baralhos de estudo.",
                    isPositive: false,
                },
            },
            {
                category: "Sistema de estudo",
                feature: "Sistema de repetição espaçada (SRS)",
                description:
                    "Algoritmo de memória cientificamente comprovado que agenda intervalos ideais de revisão.",
                lectoro: {
                    title: "Repetição espaçada integrada",
                    detail: "Micro-revisões diárias de 5 min no popup do Chrome. Configuração zero.",
                    isPositive: true,
                },
                languageReactor: {
                    title: "Itens salvos e prática de frases",
                    detail: "Inclui ferramentas para itens salvos, com um fluxo de revisão diferente do Lectoro.",
                    isPositive: false,
                },
                lingopie: {
                    title: "Flashcards e ferramentas de repetição",
                    detail: "Inclui flashcards de vídeo e recursos de repetição dentro da assinatura.",
                    isPositive: false,
                },
                duolingo: {
                    title: "Prática personalizada",
                    detail: "Agenda prática dentro da trilha de aprendizado baseada em cursos.",
                    isPositive: false,
                },
            },
            {
                category: "Design e performance",
                feature: "Overlay moderno de vídeo e velocidade",
                description:
                    "UI estética e não intrusiva que mantém o filme no centro da experiência.",
                lectoro: {
                    title: "Glassmorphism escuro elegante",
                    detail: "Dock ultrarrápido e leve que nunca cobre ou bloqueia o vídeo.",
                    isPositive: true,
                },
                languageReactor: {
                    title: "UI de navegador focada em legendas",
                    detail: "Adiciona legendas bilíngues e controles de aprendizado em mídias compatíveis.",
                    isPositive: false,
                },
                lingopie: {
                    title: "Player de streaming dedicado",
                    detail: "Combina reprodução de catálogo com legendas clicáveis e ferramentas de aprendizado.",
                    isPositive: false,
                },
                duolingo: {
                    title: "UI gamificada de curso",
                    detail: "Usa streaks, corações e desafios; planos pagos incluem opção sem anúncios.",
                    isPositive: false,
                },
            },
            {
                category: "Custo e valor",
                feature: "Preços e acesso justo",
                description:
                    "Preço honesto sem armadilhas de assinatura nem lock-in forçado de longo prazo.",
                lectoro: {
                    title: "Plano gratuito + acesso acessível",
                    detail: "Imersão gratuita generosa. Sem cartão de crédito para começar.",
                    isPositive: true,
                },
                languageReactor: {
                    title: "Grátis + recursos Pro",
                    detail: "Acesso principal é gratuito; recursos como tradução automática estão no Pro.",
                    isPositive: false,
                },
                lingopie: {
                    title: "US$ 83,88 / ano listado",
                    detail: "A página oficial de preços também lista opções trimestrais e vitalícias.",
                    isPositive: false,
                },
                duolingo: {
                    title: "Grátis + assinaturas pagas",
                    detail: "Super adiciona sem anúncios, corações ilimitados e prática extra; preços variam por mercado.",
                    isPositive: false,
                },
            },
        ],
