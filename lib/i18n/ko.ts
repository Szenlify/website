...
export const ko: Dict = {
    ...
    meta: {
        ...
        reviewsTitle: "단어 복습 및 간격 반복 플래시카드",
        reviewsDesc:
            "Netflix와 YouTube에서 저장한 단어를 영상 플래시카드와 SRS 간격 반복 알고리즘으로 효율적으로 복습하고 기억하세요.",
    },
    ...
    reviews: {
        ...
        title: "단어 복습",
        subtitle: "Netflix와 YouTube에서 저장한 단어를 효과적으로 복습하세요.",
        breadcrumbHome: "홈",
        breadcrumbDashboard: "대시보드",
        breadcrumbReviews: "복습",
        loadingTitle: "클라우드에서 복습 단어 불러오는 중...",
        loadingSubtitle: "Firebase Firestore에 연결 중...",
        dbErrorTitle: "데이터베이스 오류",
        retryButton: "다시 시도",
        noWordsTitle: "클라우드에 저장된 단어가 없습니다",
        noWordsSubtitle: "해당 계정에 대해 Firebase 클라우드에 저장된 단어를 찾을 수 없습니다.",
        syncHowToTitle: "Lectoro 확장 프로그램에서 단어를 동기화하는 방법:",
        syncStep1: "Chrome 툴바에서 Lectoro 확장 프로그램을 엽니다.",
        syncStep2: "설정 / 클라우드 탭을 클릭합니다.",
        syncStep3: "동일한 Google 계정으로 로그인되어 있는지 확인하세요",
        syncStep4: "'동기화' 버튼을 클릭하면 영상에서 저장한 단어가 클라우드로 업로드됩니다.",
        refreshButton: "복습 새로고침",
        allCaughtUpTitle: "복습할 카드가 없습니다!",
        allCaughtUpDesc: "모든 단어 복습을 마쳤습니다. 다음 복습은 SRS 간격 반복 알고리즘에 따라 예정됩니다.",
        totalSavedWords: "저장된 총 단어 수:",
        practicePromptTitle: "지금 미리 연습하시겠습니까?",
        practicePromptDesc: "SRS 대기 시간 없이 저장된 모든 단어를 지금 바로 연습할 수 있습니다.",
        practiceAllButton: "모든 카드 연습하기",
        checkNewButton: "새로운 복습 확인",
        sessionCompleteTitle: "세션 완료!",
        sessionCompleteDesc: "이번 세션의 모든 복습을 완료했습니다! 장기 기억에 성공적으로 각인되었습니다.",
        exitPracticeButton: "연습 모드 종료",
        changeDirection: "학습 방향 전환",
        cramBadge: "연습 모드",
        listenAudio: "발음 듣기 (W)",
        movieSnapshotAlt: "영상 장면 캡처",
        mobileSwipeHint: "← 스와이프: 모름 • 탭: 뒤집기 • 앎: 스와이프 →",
        flipShowAnswer: "정답 보기 (뒤집기)",
        flipShowQuestion: "문제 보기 (뒤집기)",
        mobileTapFlip: "탭하여 카드 뒤집기",
        rateMemoryPrompt: "기억 상태 평가:",
        knowWordPrompt: "이 단어의 뜻을 알고 계신가요?",
        btnAgain: "모름",
        btnGood: "앎",
        badgeAgain: "다시",
        badgeGood: "알고 있음",
        ...
        unauthDesc: "Netflix와 YouTube에서 저장한 단어를 간격 반복으로 확실하게 기억하세요.",
